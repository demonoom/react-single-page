...
export default class HomeWorkUnderstandAnalysisGuide extends React.Component {
    ...
    analysisByClass(){
        ...
        if(this.state.value == 0){
            analysisUrl = "http://localhost:8091/#/homeWorkUnderstandAnalysisByClass?clazzId="+clazzIdStr+"&pushTime="+dayStr;
        }else{
            analysisUrl = "http://localhost:8091/#/homeWorkUnderstandAnalysisByClassSubject?clazzId="+clazzIdStr+"&pushTime="+dayStr;
        }
    ...
    render() {
        ...
        return (
            <div id="homeWorkAnalysis">
                ...
                <div>
                    <iframe src={this.state.analysisUrl}></iframe>
                </div>
            </div>
        );
    }
