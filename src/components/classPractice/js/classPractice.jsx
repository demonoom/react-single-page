...
export default class classPractice extends React.Component {
    ...
    render() {
        ...
        return (
            <div id="classPractice" className='classPractice classroomPractice'>

                <div className="classPractice-class" style={{ overflow: 'hidden' }}>
                    <div className="classPractice-bottom">
                        <span className="tal classPractice-title">三年级三班
                        {/* {this.state.className} */}
                        </span>
                        <span className="tac">练习时间: 2012-12-12
                        {/* {this.state.pushDate} */}
                        </span>
                        <span className="tar">题目总数: {this.state.subjectCount}
                        </span>
                    </div>
                    {/* <div className="classPractice-bottom"> */}
                    {/* </div> */}
