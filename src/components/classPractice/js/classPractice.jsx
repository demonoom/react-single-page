                    ...
                    <div className="topic_list">
                       {/*题目统计*/}
                        ...
                        {this.state.topicDataInStu.length==0?
                            <div className="empty_center" style={{display:this.state.topicDataInStu.length==0?"":'none'}}>
                                <div className="classPractice-empty"></div>
                                <div className="classPractice-emptyText">暂无数据</div>
                            </div>:
                    ...
                    <div className="performance-list">
                        ...
                        <div className="performance-cont">
                            {this.state.correctData.length==0?
                                <div className="empty_center" style={{display:this.state.correctData.length==0?"":'none'}}>
                                    <div className="classPractice-empty"></div>
                                    <div className="classPractice-emptyText">暂无数据</div>
                                </div>:
                    ...
                    <div className="performance-list">
                        ...
                        <div className="performance-cont">
                            {this.state.answerTime.length==0?
                                <div className="empty_center" style={{display:this.state.answerTime.length==0?"":'none'}}>
                                    <div className="classPractice-empty"></div>
                                    <div className="classPractice-emptyText">暂无数据</div>
                                </div>:
