        ...
        return (
            <div id="termitePlateLibrary">
                <div className="ant_title">
                    <span className="ant_btn_list"><img className="ant_btn_img" src={require('../imgs/icon_ant_new.png')} alt=""/><span>新建</span></span>
                    <span className="ant_btn_line"></span>
                    <span className="ant_btn_list"><img className="ant_btn_img" src={require('../imgs/icon_ant_uploading.png')} alt=""/><span>上传</span></span>
                </div>
