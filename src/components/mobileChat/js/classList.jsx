...
export default class classList extends React.Component {
    ...
    itemOnClick(rowData) {
        return () => {
            ...
            window.location.href = encodeURI(WebServiceUtil.mobileServiceURL + 'friendList?fromId=' + class_List.state.userId + '&colPasswd=' + colPasswd + '&unionid=' + unionid + '&clazzId=' + rowData.id)
        }
    }
