$(function () {
    ...
    //可编辑标签文本点击事件
    $('.editor_box').on('click', '.editor_text', function () {
        ...
        $('.jscolor').val(color);
        $(this).css({border: '1px solid #778'});
        $('.editor_position').show(200);
        $('.editor_position').css({top: $(this).offset().top, left: $(this).offset().left})
        editor_this = this;
