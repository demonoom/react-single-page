...
export default class classCardHomePageDoor extends React.Component {
     ...
     */
    turnToRingBinding = () => {
        var url = WebServiceUtil.mobileServiceURL + "boxBracelet?ident=" + this.state.ident;
        var data = {
            method: 'openNewPage',
            url: url
        };
    ...
    turnToRingManage = () => {
        // var url = WebServiceUtil.mobileServiceURL + "classTimingList?uid=" + this.state.ident + "&sid=" + this.state.schoolId;
        var url = WebServiceUtil.mobileServiceURL + "clazzOfRingBinding?ident=" + this.state.ident;
        var data = {
            method: 'openNewPage',
            url: url
        };
